...
ico:	  game
title:   【Unity3D游戏开发实战】Unity3D实现休闲类游戏《2048》——算法、源代码
...
## 一、前言
最近有粉丝要参加游戏创作大赛，问我需要准备学习什么知识，以及参加比赛的注意事项：
...
参加这类比赛是非常有好处的，不仅提高了技术，也增长了见识。

因为是兴趣驱动学习，在完善自己心爱游戏的过程中，要不断的去学习，不断的提高自己。

更能在这个过程中找到志同道合的好朋友。

那今天就简单的聊一下，制作一个简单游戏，需要具备哪些技术栈，以及参加这类比赛需要的知识基础。
...
（1）比赛报名首先需要确认名单，是以个人、公司、组织的名义来参赛的。

如果是```个人```参赛需要年满18周赛；如果是```公司```名义参加比赛，则需要完成机构认证；如为```团队```作品，需要报名时提供团队成员信息。

（2）在赛事专题页，提交资料报名，根据所选赛区要求提交作品。

（3）赛区分为试玩包组和视频组，```试玩包组```需要提供可运行的Demo及PPT演示，完成度要在60%以上，可正常流畅运行，没明显BUG；```视频组```需包含演示视频及PPT演示，需要明确展示游戏的设计思路、方法方式等。

然后，就是奖项，分为金、银、铜奖，还有优胜奖、创意/人气奖、赛会特别奖等，最高奖励10W，奖金丰厚。

总结一下，就是先报名，然后选择试玩还是视频，最后提交作品即可。

对啦，报名/提交作品的时间为```2022年3月16日至4月18日```，记得在这个时间段报名及提交作品。

```个人分析建议：```

此次赛事，是通过比赛的方式激发对游戏创作的激情，发掘游戏相关人才、作品、创意，给真正喜欢游戏的人提供平台。
...
好的创意、作品会得到资源支持，签约发行，作品推广等。

下面就实现一个休闲类游戏《2048》，抛砖引玉一下。
